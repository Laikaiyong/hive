								...
								<Timeline.Body>
									...
									>
										...
										<div className='mt-4 flex space-x-3 lg:mt-6'>
											...
											<a
												href='https://dial.to/?action=solana-action:https://hive-inky.vercel.app/api/upvote'
												target='_blank'
												className='inline-flex items-center rounded-lg border border-gray-300 bg-white px-4 py-2 text-center text-sm font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:hover:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-700'
											>
												Blink It &nbsp;
						...
						<Accordion.Panel>
							...
							<Accordion.Content>
								<p className='mb-2 text-gray-500 dark:text-gray-400'>
									The purpose of this Hive News is to track the upvote and downvote action in the
									news decentralized authenticable application. It will manage user, news and votes
									for the solution.
								</p>
							</Accordion.Content>
						</Accordion.Panel>
