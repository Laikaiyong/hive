...
const NewsLeaderboard = () => {
    return (
        <>
    <section style={pageStyles} class="bg-white dark:bg-gray-900">
      <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div class="max-w-screen-md mb-8 lg:mb-16">
              <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Top 10 Hot News in (February)</h2>
              <p class="text-gray-500 sm:text-xl dark:text-gray-400">These news are the highest authenticated by community contributors!</p>
          </div>
          <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
              <div>
                  ...
                  <h3 class="mb-2 text-xl font-bold dark:text-white">Avengers 90th Anniversary</h3>
                  <p class="text-gray-500 dark:text-gray-400">888 contributions</p>
              </div>
              <div>
                  <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                  ...
                  <h3 class="mb-2 text-xl font-bold dark:text-white">Nottingham shut down all campuses</h3>
              ...
              <div>
                  ...
                  <h3 class="mb-2 text-xl font-bold dark:text-white">One Pieces Season 900 is now Up</h3>
      ...
      <section style={pageStyles2} class="bg-white dark:bg-gray-900 ml-60">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div class="mb-4">
            ...
            {[
              { name: "Mickey Mouse Club House", contributions: 50 },
              { name: "Godzilla VS Ironman", contributions: 30 },
              { name: "Japan Kikoneko launches", contributions: 20 },
              { name: "NASA Laser invented", contributions: 15 },
              { name: "2024 CNY Dragon", contributions: 10 },
              { name: "Find Dory", contributions: 5 },
              { name: "Find Nemo", contributions: 2 },
            ].map((user, index) => (
...
export default NewsLeaderboard;

export const Head = () => <title>News Leaderboard</title>;